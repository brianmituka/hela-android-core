...
public class FragmentSettingsBackup extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View vFragSettingsProfile =inflater.inflate(R.layout.fragment_settings_backup,container,false);
    ...
    private void initializeVariablesAndUIObjects(@NonNull View fragmentLayout) {
        ...
        imgvBack.setOnClickListener(clkSettingsBackup);
        ...
        if (acactParentActivity != null) {
            ...
            if (abActivityActionBar != null) {
                abActivityActionBar.setTitle(getString(R.string.titleBackup));
    ...
    private void codeToNavigateBack() {
        ...
        NavHostFragment.findNavController(FragmentSettingsBackup.this).navigateUp();
