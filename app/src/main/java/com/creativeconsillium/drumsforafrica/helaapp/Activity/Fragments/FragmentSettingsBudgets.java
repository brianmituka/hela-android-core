...
public class FragmentSettingsBudgets extends Fragment {

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        super.onCreateView(inflater, container, savedInstanceState);

        View vFragSettingsBudgets = inflater.inflate(R.layout.fragment_settings_budget_choice, container, false);
        initializeVariablesAndUIObjects(vFragSettingsBudgets);

        return vFragSettingsBudgets;
    }
    ...
    private void initializeVariablesAndUIObjects(@NonNull View fragmentLayout) {
        ...
        imgvBack.setOnClickListener(clkSettingsBudgets);
        ...
        if (acactParentActivity != null) {
            ...
            if (abActivityActionBar != null) {
                abActivityActionBar.setTitle(getString(R.string.profileMyBudgets));
    ...
    private void codeToNavigateBack() {
        ...
        NavHostFragment.findNavController(FragmentSettingsBudgets.this).navigateUp();
