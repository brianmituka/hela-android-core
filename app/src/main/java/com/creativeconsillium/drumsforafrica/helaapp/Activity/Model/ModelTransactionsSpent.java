...
public class ModelTransactionsSpent {
    ...
    public ModelTransactionsSpent(String transactionSpentDate, String transactionSpentBudget, String transactionSpentAmount,
