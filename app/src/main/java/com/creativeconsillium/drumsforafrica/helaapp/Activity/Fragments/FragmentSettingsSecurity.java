...
public class FragmentSettingsSecurity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View vFragSettingsProfile =inflater.inflate(R.layout.fragment_settings_security,container,false);
    ...
    private void initializeVariablesAndUIObjects(@NonNull View fragmentLayout) {
        ...
        imgvBack.setOnClickListener(clkSettingsSecurity);
        ...
        if (acactParentActivity != null) {
            ...
            if (abActivityActionBar != null) {
                abActivityActionBar.setTitle(getString(R.string.titleSecurity));
    ...
    private void codeToNavigateBack() {
        ...
        NavHostFragment.findNavController(FragmentSettingsSecurity.this).navigateUp();
